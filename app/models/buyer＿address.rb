class BuyerAddress
  ...
  def save
    ...
    Send_Address.create(buyer_id: buyer.id, post_code: post_code, area_id: area_id, city: city, address_number: address_number, house_name: house_name, telephone: telephone)
  end
end
